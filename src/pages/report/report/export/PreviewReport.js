        ...
        <div className="check">
          <div className="headers">
            <div className="header_left">
              ...
              <div className="companyName">
                ...
                <span className="com2">QUY TRÌNH KIỂM SOÁT BẢO TRÌ </span>
              </div>
            </div>
            <div className="header_right">
              <div className="companyName">
                <span className="com1">Mã hiệu: KSBT-BC-01</span>
                <span className="com2">Ngày ban hành: 05-01-2016</span>
                <span className="com2">Lần ban hành: 01</span>
              </div>
            </div>
          </div>
          <h2
          ...
          <div className="footerr">
            <p style={{ fontStyle: "italic" }}>
              Ha noi, Date 26 month 03 year 2020
            </p>
